...
Next, the further step will consist in downloading of [RainMeter](https://www.rainmeter.net) <i>customization tool</i>. It allows enabling different design modules, called "skins" on the desktop workspace. Some can be [found here](https://www.rainmeter.net/discover/).

The wallpaper used can be [downloaded here](https://raw.githubusercontent.com/ArmynC/ArminC-Windows-Debloat/main/rice/your_name_landscape_wallpaper.png). Next on the list, the  date and time skin used is [River](https://www.deviantart.com/catart-1304/art/River-0-1-Cat-Art-ft-Luna-Hibiki-917665182), with a manually near top-left position. Don't forget to install the font from skin's @Resource directory (seek the manager). The included resource monitor is placed at bottom-right. The shorcuts such as This PC, Recycle Bin and such more are avoided in their classical way and used in a [fancy Corner dock](https://www.deviantart.com/sinndbad/art/Corner-Dock-839311234) instead. Now, this one is (even more) customizable through an configuration file and icon files too. The bottom dock is disabled and the right one is kept (to activate press the ribbon's empty area). The icons and shortcuts are custom too.

At the end of customization process, do open the RainMeter <i>manager</i> and for each skin <i>.ini</i> file, disable the <b>draggable</b> attribute to avoid messing them up.
...
[![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/)<h1 align="center">
  <br>
  <a href="https://github.com/ArmynC/ArminC-Windows-Debloat/archive/refs/heads/main.zip"><img src="https://raw.githubusercontent.com/ArmynC/ArminC-Windows-Debloat/main/img/arminc_windows_debloat.svg" alt="Windows Debloat"></a>
</h1>
